...
class __TwigTemplate_ff92a7013b735644be5aca46ff03f8007597e24b3b0f314e7423b28ec9f46651 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["class_columns"] ?? null)];
        ...
        <a href=\"";
                    ...
                    // line 62
                    echo "          ";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "title", [], "any", false, false, true, 62), 62, $this->source));
  ...
  ";
    ...
    {
        return new Source("", "themes/gavias_kunco/templates/navigation/menu--main.html.twig", "/Users/bradwaye/Sites/kunco/themes/gavias_kunco/templates/navigation/menu--main.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("import" => 23, "macro" => 31, "if" => 33, "for" => 40, "set" => 41);
        static $filters = array("escape" => 35, "join" => 47, "without" => 60, "raw" => 62);
        static $functions = array();

        try {
            $this->sandbox->checkSecurity(
                ['import', 'macro', 'if', 'for', 'set'],
                ['escape', 'join', 'without', 'raw'],
                []
            );
